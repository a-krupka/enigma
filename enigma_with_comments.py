...
def position(letter,pos):
       """Přičte k písmenu hodnotu z rotoru (váš input)"""
...
decyphered = ""
text = "aopbq sqdqh xou" #Tohle je zkouska"
for i in text.upper().replace(" ",""):
       ...
       if rotor1[pozice_P][1] != "":  # notch check
              pozice_M = plusone(pozice_M)
       if rotor2[pozice_M][1] != "": # notch check
       ...
       rot2 = rotor2[pis_cis[rot1]][0][rot1]
